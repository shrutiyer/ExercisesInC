...
When I increased the number of children to 1000, there were many threads reading the same value for the counter. But the final value is still correct showing that the threads are working concurrently and properly.

When I ran 2000 threads, there were errors in the final sum, indicating some synchronization errors.
...
A lot of synchronization errors occurred.
...
```
$:~/ExercisesInC/exercises/ex12$ time ./counter_array

real	0m0.032s
user	0m0.051s
sys	0m0.000s
$:~/ExercisesInC/exercises/ex12$ time ./counter_mutex

real	0m0.075s
user	0m0.064s
sys	0m0.072s
```
The real overhead is 0.043s
